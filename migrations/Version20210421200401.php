 ...
 */
final class Version20210421200401 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category ADD CONSTRAINT FK_64C19C1B852C405 FOREIGN KEY (shop_id_id) REFERENCES shop (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
